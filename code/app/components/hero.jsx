  ...
  return (
    <section className="hero p-6 px-10">
      <div className="h-screen flex flex-col justify-center items-center text-center text-white">
        <h1 className="sm:text-5xl text-3xl sm:text-center text-right font-bold mb-4 sm:w-2/4 leading-relaxed">
        ...
        <p className="fade sm:text-lg sm:text-center text-sm text-right mb-8 max-w-md line text-gray-300 leading-loose">
