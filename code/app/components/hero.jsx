    ...
    return (
        <section className="hero p-4">
            <div className='h-screen flex flex-col justify-center items-center text-center text-white'>
                <h1
                    className="text-4xl font-bold mb-4 leading-tight sm:text-5xl sm:leading-normal sm:w-2/4"
                >
                    اطلق عنان إبداعك على الإنترنت مع حلول <span className='text-[#CEEC33]'>التصميم والتطوير المبتكرة</span>
                </h1>
                <p

                    className="text-lg mb-8 max-w-md text-gray-300"
                >
                ...
                <div
                    ...
                    className='mt-20'
                >
                    <h4 className='p-10'>  <strong>شراكتنا </strong>السابقة</h4>
                    <Logos />
                </div>
            </div>
        </section>
